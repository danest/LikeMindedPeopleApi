  ...
  def create
    ...
    respond_to do |format|
      if @characteristic.save
        format.html { redirect_to @characteristic, notice: "#{t('activerecord.successful.messages.created', model: @characteristic.class.model_name.human)}" }
  ...
  def update
    ...
    respond_to do |format|
      if @characteristic.update_attributes(params[:characteristic])
        format.html { redirect_to @characteristic, notice: "#{t('activerecord.successful.messages.updated', model: @characteristic.class.model_name.human)}" }
